function [choices, RT] = doSampling_highCoh(cueLevel, coherenceLevel, congruent)
...
outfile = sprintf('results/%.1fcue_%.1fcoh_%icong_%isubs_%itrials_weakAntCoh.mat', cueLevel, coherenceLevel, congruent, nSub, nTrial);
save(outfile)

% comment out this line if you don't want to auto-generate plots
plotTraces(outfile)
end
